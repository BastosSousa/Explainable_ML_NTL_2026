...
print("\n" + "=" * 50)
print("MODEL PERFORMANCE COMPARISON (VALUE IN GWh)")
print("=" * 50)
...
def evaluate_model(X_data, y_data, title="Model", model_key="global"):
    ...
    print(f"Average RMSE [GWh]: {mean_rmse:.4f}") 
    print(f"Average MAE [GWh]: {mean_mae:.4f}\n")
...
print("\n" + "=" * 50)
print("Importance by INKAR Groups (GeoSHAP in GWh):")
print("=" * 50)
print(ser_geoshap)
