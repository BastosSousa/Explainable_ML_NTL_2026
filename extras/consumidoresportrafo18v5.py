...
#%%
dados_todos_12['UNI_TR_MT'] = dados_todos_12['UNI_TR_MT'].astype(str)

#%%
dados_todos_13 = dados_todos_13.mask(dados_todos_13.eq('None')).dropna()

#%%
dados_todos_13['UNI_TR_MT'] = dados_todos_13['UNI_TR_MT'].astype('int64')

#%%
dados_todos_13['UNI_TR_MT'] = dados_todos_13['UNI_TR_MT'].astype(str)
...
selec =['UC','LATITUDE','LONGITUDE','UNI_TR_MT','Cod_setor','PO_NOMINAL_TRAFO', 'Dif','Porc']
...
#%%
data_simulation_3 = data_simulation_2.rename(columns=dict(zip(old_names, new_names)))
