...
# %%
dados_todos_2 = dados_todos_2[['UC', 'TIPO', 'MEDIDOR', 'ANO', 'COMPLEMENTO', 'BAIRRO', 'CIDADE', 'REGIONAL',
                                'TIPO_FASE', 'SITUACAO', 'DISJUNTOR', 'UNI_TR_MT', 'POT_NOMINAL', 'CD_ALIMENTADOR', 'LATITUDE', 'LONGITUDE'
                               ]]
...
# %%
dados_todos_6 = dados_todos_5[['CD_GEOCODI', 'UC', 'TIPO_left', 'MEDIDOR', 'BAIRRO', 'CD_ALIMENTADOR', 'LATITUDE',
                               'LONGITUDE', 'centroid', 'UNI_TR_MT', 'POT_NOMINAL','PO_NOMINAL_TRAFO', 'Dif', 'Porc']]
...
# %%
join_left_df_novo = join_left_df_novo[['Cod_setor', 'UDH_ATLAS_left', 'UNI_TR_MT', 'CD_ALIMENTADOR', 'UC', 'TIPO_left', 'MEDIDOR', 'BAIRRO', 'Situacao_setor',
                                       'Tipo_setor', 'domicilio', 'medio_pessoas', 'rend_responsavel', 'rend_medio', 'saneamento',
                                       '%alfabetizados', '%ate5salarios', '%5a10', 'geometry', 'centroid_right', 'LATITUDE', 'LONGITUDE', 'PO_NOMINAL_TRAFO','POT_NOMINAL', 'Dif',
                                       'Porc']]
...
#%%
teste_2 = teste_2.reset_index()

#%%

resultado_2 = resultado.dropna().reset_index()
...
gdf_dados_todos_12.to_excel('C:\Pos\entradas\gdf_dados_todos_12.xlsx')  
...
# gdf_dados_todos_11.plot(facecolor="none", edgecolor="yellow", ax=ax)
