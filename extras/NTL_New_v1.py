...
df3_data.drop(columns = ['LATITUDE', 'LONGITUDE','geometry', 'UNI_TR_MT','UNI_TR_MT LABEL','pop_count_local_moran','comp1', 'comp2','segment_kmeans_umap', 'segment', 'target'], inplace = True)
