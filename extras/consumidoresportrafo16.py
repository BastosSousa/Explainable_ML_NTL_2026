...
#%%
gdf_dados_todos_4 = gdf_dados_todos_4.set_crs(31982)

#gdf_dados_todos_4.crs = shape_bairros.crs

#%%
gdf_dados_todos_4['geometry'] = gdf_dados_todos_4.geometry.to_crs(31982)

shape_UCs = gdf_dados_todos_4.sjoin(shape_bairros_2, how="left")

shape_UCs = shape_UCs[shape_UCs['cd_uep'].notna()]

bairros_UCS = gdf_dados_todos_4.Bairro.drop_duplicates()
...
shape_UCs_merge = pd.merge(shape_bairros, nbh_count_df, on='cd_uep')
